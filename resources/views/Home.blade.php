...
<div class="hero-slider">
	<div class="slider-item th-fullpage hero-area" style="background-image: url({{ asset('template/images/slider/Slide1.jpeg') }});">
		<div class="container">
			<div class="row">
				<div class="col-md-12 text-center">
					<h1 data-duration-in=".3" data-animation-in="fadeInUp" data-delay-in=".1">Masjid Assidas <br>
						Ampel Boyolali</h1>
					<p data-duration-in=".3" data-animation-in="fadeInUp" data-delay-in=".5">Pucang, Ngargosari, Kec. Ampel, Kabupaten Boyolali, Jawa Tengah 57352</p>
					<a data-duration-in=".3" data-animation-in="fadeInUp" data-delay-in=".8" class="btn btn-main" href="service.html">Tentang Masjid Assidas</a>
				</div>
			</div>
		</div>
	</div>
	<div class="slider-item th-fullpage hero-area" style="background-image: url({{ asset('template/images/slider/Slide2.jpeg') }});">
		<div class="container">
			<div class="row">
				<div class="col-md-12 text-center">
					<h1 data-duration-in=".3" data-animation-in="fadeInDown" data-delay-in=".1">Madrasah Diniyyah <br> Assidas</h1>
					<p data-duration-in=".3" data-animation-in="fadeInDown" data-delay-in=".5">Pendidikan Keagamaan dengan Metode Mempelajari Kitab-kitab dari Para Ualama' Salaf
						<br> untuk Berbagai Kalangan Anak-anak,Remaja,dan Orang Tua</p>
					<a data-duration-in=".3" data-animation-in="fadeInDown" data-delay-in=".8"  class="btn btn-main" href="service.html">Tentang Masjid Assidas</a>
				</div>
			</div>
		</div>
	</div>
	<div class="slider-item th-fullpage hero-area" style="background-image: url({{ asset('template/images/slider/Slide3.jpeg') }});">
		<div class="container">
			<div class="row">
				<div class="col-md-12 text-center">
					<h1 data-duration-in=".3" data-animation-in="fadeInDown" data-delay-in=".1">Pengajian Rutin<br> Sabtu Malam</h1>
					<p data-duration-in=".3" data-animation-in="fadeInDown" data-delay-in=".5">Pengajian Rutin Untuk Umum yang bertempat di Pendopo Masjid Assidas </p>
					<a data-duration-in=".3" data-animation-in="fadeInDown" data-delay-in=".8"  class="btn btn-main" href="service.html">Tentang Masjid Assidas</a>
				</div>
			</div>
		</div>
	  ...
	  <div class="row">
		...
		<div class="col-12">
		  ...
		  <div class="title text-center">
			<h2>Masjid Assidas</h2>
			<p>Pucang, Ngargosari, Kec. Ampel, Kabupaten Boyolali, Jawa Tengah 57352</p>
		  ...
		  <div class="row text-center">
			<div class="col-md-6 col-sm-6 col-xs-12">
			  ...
			  <div class="service-item">
				...
				<h4>Gallery</h4>
				<p>Kumpulan Foto Kegiatan di Masjid Assidas.</p>
			  </div>
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
				<div class="service-item">
				  ...
				  <h4>Agenda</h4>
				  <p>Kumpulan Agenda/Program di Masjid Assidas.</p>
				</div>
			  </div><!-- END COL -->
			<div class="col-md-6 col-sm-6 col-xs-12">
			  <div class="service-item">
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
			  <div class="service-item">
				...
				<h4>Contact</h4>
				<p>Kami menerima Saran Masukan dan Kritikan demi Kemajuan dan Kemakmuran Masjid Assidas</p>
			  </div>
			</div><!-- END COL -->
		  </div>
		</div>
